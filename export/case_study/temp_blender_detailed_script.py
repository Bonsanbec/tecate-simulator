...
def run():
    ...
    with open("/Users/hakkindavid/Documents/GitHub/tecate-simulator/export/case_study/element_detection_report.json", "r", encoding="utf-8") as f_in:
        report = json.load(f_in)
    with open("/Users/hakkindavid/Documents/GitHub/tecate-simulator/data/facades_cache.json", "r", encoding="utf-8") as f_in:
