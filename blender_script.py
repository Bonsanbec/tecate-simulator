...
def main():
    ...
    # Export fully textured glTF asset to godot_project/assets/blocks/geometry.gltf
    gltf_path = f"godot_project/assets/blocks/geometry{'_textureless' if skip_textures else ''}.gltf"
